...
import { DeviceSelectionModalData, ComboCreationResult } from '../../../core/interfaces/combo-create.models';
  ...
  template: `
    ...
    <div class="modal-body">
      <div class="template-info mb-3" *ngIf="data.selectedTemplate">
        ...
        <p><strong>Screen Size:</strong> {{data.selectedTemplate.screenSize}}</p>
      </div>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr *ngFor="let device of filteredDevices" 
                ...
                <td>
                  <input type="radio" name="deviceRadio" 
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" 
        ...
        <span *ngIf="creatingCombo" class="spinner-border spinner-border-sm me-2"></span>
...
export class DeviceSelectionModalComponent implements OnInit {
  ...
  getStatusClass(status: string): string {
    switch (status?.toLowerCase()) {
      ...
      case 'offline': return 'badge badge-offline';
