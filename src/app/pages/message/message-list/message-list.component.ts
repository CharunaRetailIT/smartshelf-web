...
import { Message, MessageWithUser } from '../../../core/interfaces/message.interface';
...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, FormsModule, MatInputModule, MatTableModule, MatPaginatorModule, MatIconModule, MatSelectModule, RouterModule],
...
export class MessageListComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource<MessageWithUser>();
  // Updated displayedColumns to include actions
  displayedColumns: string[] = ['title', 'content_type', 'is_active', 'created_by', 'created_at', 'actions'];
  ...
  deleteMessage(message: any): void {
    ...
    dialogRef.afterClosed().subscribe(async (result) => {
      if (result === true) {
        try {
          await firstValueFrom(this.messageService.deleteMessage(message.id, this.currentUserId, this.storeId));
